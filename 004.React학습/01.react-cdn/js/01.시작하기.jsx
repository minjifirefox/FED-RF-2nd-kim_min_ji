...
function MyFirstReact(){
    ...
    return (
        <React.Fragment>
            ...
            {/* <img src="https://64.media.tumblr.com/f51ea4b743fbd916b7d25072125d0ddc/tumblr_pmmhjnMXo61tv58w2_1280.jpg" alt="이미지" /> */}
            ...
            <h2>[ 리액트란 무엇인가? ]
                ...
                #리액트 기초 배우기 영상 <br />
                <iframe width="100%" height="720" src="https://www.youtube.com/embed/MHn66JJH5zs?si=2iSM5X1x7qkQ_rYm" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </h2>
        </React.Fragment>
    );
} /////////// MyFirstReact 생성자 함수 ////////////////////
