...
// 리액트에서는 from 뒤 파일명에 "js/jsx"를 생략해도 됨!
...
// 출력: 세번째 .root
ReactDOM.render(<FavoriteThings color="보라색" food="계란찜" hobby="그림그리기" />,target[2]);

// 출력: 네번째 .root
ReactDOM.render(<FavoriteThings color="분홍색" food="묵사발" hobby="쇼핑하기" />,target[3]);
