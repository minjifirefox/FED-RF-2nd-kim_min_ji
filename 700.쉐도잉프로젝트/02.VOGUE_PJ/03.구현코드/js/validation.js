...
form.logF input[type=password]`;
  ...
  $(tgInput).blur(function () {
    ...
    // 플래그(flag)는 기술 용어로 처리 표시 기호를 뜻함
    ...
    if (cv == "") {
      ...
      // 형제 요소들 중 .msg인 요소에 글자를 출력함
      // 현제 요소 선택은 siblings(특정이름)
     ...
     ****************************************/
      ...
      // 이메일 뒷 주소응 직접 입력("free")이면 뒷 주소 입력창
      // 아니면 선택 박스 option value 값을 가져온다!
  ...
  $("#email1, #email2").on("keyup", function () {
    ...
    let backEml =
      cid == "email2"
        ...
        ? seleml.val()
        : eml2.val();
    // 현재 입력 아이디가 "email2"이면 직접 입력 창을 읽고
    // 아니면 선택 박스 값이 "free"가 아닌 경우에 선택 박스 값 읽고
    // 아니면 직접 입력 창 값을 뒷 주소로 설정함!
