...
// GNB 메뉴 코드 넣기
// 대상 : .gnb
// 데이터 : gnbData는 객체니까 배열용 map() 메서드 못 씀!
// 그래서 gnbData를 키배열로 변환해서 사용함!
// 그리고 이 객체의 key는 상위메뉴이기도 함!
// Object.keys(객체) -> 해당 객체의 속성명(키) 배열 생성!
...
(() => {
  ...
  // console.log(
  // 배열값인 갹채의 idx 키 값을 기준으로 내림차순 정렬을 할 때 문자형 숫자이므로 Number() 숫자형변환 메서드로 싸서 숫자로써 비교하여 정확한 내림차순이 되도록 한다!
  pData.sort(
    (a,b)=>
