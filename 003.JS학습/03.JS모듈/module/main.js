...
// [import 방법1 : 보내준 이름 그대로 쓰기]
// import {mTitle,sTitle,personInfo,mvData} from './text_data.js';

// [import 방법2 : 별칭 지어서 쓰기]
// -> 별칭을 지었으면 반드시 별칭으로 사용해야함!
// import {mTitle as mTit,sTitle as sTit,personInfo as pInfo,mvData as mdt} from './text_data.js';

// [import 방법3 : 한꺼번에 불러오기 - *사용!]
// -> import * as 별칭 from 경로
// -> 별칭 이름으로 한꺼번에 불러온 값을 객체에 담음
// -> 모듈용 전용객체에 저장하여 객체.변수명으로 사용함
...
contBox.innerHTML = makeMsg('쇼타로',25);
contBox.innerHTML += makeMsg('김한주',29);
contBox.innerHTML += makeMsg('김민지',25);
