...
// -> 내보내기할 때 함수명이 중요치 않으므로 익명함수로 내보내기를 해도 무관하다!
...
// 4. 화살표함수를 만들고 함수 앞에서 export default 하기
// -> 내보내기할 때 함수명이 중요치 않으므로 화살표함수로 내보내기를 해도 무관하다!
// 이 때 화살표함수는 리턴키워드 생략이 가능할 경우 이를 생략한다!
...
/****************************************************************************************** 
    ...
    단, 받는 곳에서 import시 이름은 중요하지 않다!(내가 이름을 지울 수 있음!)
