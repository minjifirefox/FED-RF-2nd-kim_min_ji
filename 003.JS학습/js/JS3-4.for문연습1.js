...
// 왜 0부터인가? HTML 컬렉션이 0부터 시작함(유사배열)
...
function resetMini() {
    ...
    // 3. 변경내용 : 내부 태그 모두 삭제
    Bcase.innerHTML = "";
    // innerHTML에 빈 문자 값을 할당하여 지운다!

    // 4. 추가 변경 대상 : .stxt span -> stxt 변수
    // 5. 추가 변경 내용 : 0으로 초기화
    stxt.innerText = 0;

    // 6. 이미지 개수 저장 번역변수를 0으로 초기화함!
    count = 0;
